        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            ...
            <StatusBar backgroundColor='blue' barStyle={"light-content"}/>
                <View style={s.form}>
                    ...
                    <TextInput placeholder="E-Mail" value={email} onChangeText={setEmail} style={s.inputs} />
                    <TextInput placeholder="Senha" value={senha} onChangeText={setSenha} style={s.inputs} />
